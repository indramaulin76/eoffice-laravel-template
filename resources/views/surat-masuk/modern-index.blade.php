...
<div class="mb-8">
    ...
    <p class="mt-2 text-sm text-gray-600">Kelola surat masuk dengan sistem digital</p>
</div>
@endsection
...
<x-modern-table :title="'Data Surat Masuk'" :searchable="true">
    <x-slot name="actions">
        @can('buat surat')
    ...
    <tr class="hover:bg-gray-50 transition-colors duration-150">
        ...
        <td class="px-6 py-4 whitespace-nowrap">
            <div class="text-sm text-gray-900">{{ $surat->asal }}</div>
        </td>
        <td class="px-6 py-4">
    ...
    <tr>
        <td colspan="7" class="px-6 py-12 text-center">
            <div class="flex flex-col items-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada surat masuk</h3>
                <p class="text-gray-500 mb-4">Mulai dengan menambahkan surat masuk pertama</p>
                @can('buat surat')
                <a href="{{ route('surat-masuk.create') }}" class="btn btn-primary">
                    Tambah Surat Masuk
                </a>
    ...
    @if(isset($suratMasuks) && $suratMasuks->hasPages())
