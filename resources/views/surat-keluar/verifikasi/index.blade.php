...
<div class="mb-8">
    ...
    <p class="mt-2 text-sm text-gray-600">Kelola verifikasi surat keluar dengan sistem digital</p>
</div>
@endsection
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    ...
    <div class="p-6">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200" id="verification-table">
            ...
            <div id="empty-state" class="hidden text-center py-12">
                ...
                <p class="text-gray-500">Belum ada surat yang perlu diverifikasi</p>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const baseRoute = "{{ route('surat-keluar.verifikasi.show', ['surat' => '__ID__']) }}";
    ...
    function loadData(status) {
        ...
        if (filteredData.length === 0) {
            ...
            document.getElementById('verification-table').classList.add('hidden');
            return;
        }

        emptyState.classList.add('hidden');
        document.getElementById('verification-table').classList.remove('hidden');

        // Populate table
        filteredData.forEach(function(surat, index) {
            const route = baseRoute.replace('__ID__', surat.nomor_surat);
